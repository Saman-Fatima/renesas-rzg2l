...
#define SEND_TYPE_MSG_CHANNEL_MASK (0x3U)

#if ((1 << y) & SEND_TYPE_MSG_CHANNEL_MASK)
#define SHM_LOCAL_OFFSET(y)  (0x08U*(y) + (0x04U*MBX_LOCAL))
#define SHM_REMOTE_OFFSET(y) (0x08U*(y) + (0x04U*MBX_REMOTE))
#else
#define SHM_LOCAL_OFFSET(y)  (0x08U*(y) + (0x04U*MBX_REMOTE))
#define SHM_REMOTE_OFFSET(y) (0x08U*(y) + (0x04U*MBX_LOCAL))
#endif
